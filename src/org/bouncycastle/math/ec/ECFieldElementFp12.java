...
public class ECFieldElementFp12 extends ECFieldElement {
	...
	ECFieldElement.Fp zero1 = new ECFieldElement.Fp(x.getPrime(),
    ...
    public ECFieldElementFp12(ECFieldElement.Fp x) {
	ECFieldElement.Fp zero1 = new ECFieldElement.Fp(x.getQ(), BigInteger
		.valueOf(0));
	ECFieldElementFp2 zero2 = new ECFieldElementFp2(zero1, zero1, true);
	for (int i = 5; i > 0; i--) {
	    c[i] = zero2;
